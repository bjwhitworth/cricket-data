...
For instance, 'Test' and multi-day ('MDM') matches are played over multiple days with typically two innings per side, so look at innings number for batting sequence. Pay attention the innings in which the game was won.
